...
nameOfFriend = "Dear " + nameOfFriend.title()
gender = ""
...
caption = (
    f"""It is with great regret that we address the untimely demise of the {whoIsDead.lower()} of our beloved colleague, {nameOfFriend.title()}. """  # noqa
    + """Our deepest sympathies and loving prayers go out to you and your beautiful family. """  # noqa
...
image_editable.text(
    ((W - w) / 2, 460), nameOfFriend, (0, 0, 0), font=nameOfFriendFont
)  # noqa
...
w, h = bbox[2] - bbox[0], bbox[3] - bbox[1]
image_editable.text(
    ((W - w) / 2, 503), andFamily, (0, 0, 0), font=nameOfFriendFont
)  # noqa
...
w, h = bbox[2] - bbox[0], bbox[3] - bbox[1]
image_editable.text(
    ((W - w) / 2, 605), whoIsDeadWording, (0, 0, 0), font=whoIsDeadFont
)  # noqa
